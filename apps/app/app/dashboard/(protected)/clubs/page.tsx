  ...
  return (
    <div className="space-y-8">
      <PageHeading
        ...
        title="Гуртки"
        description="Перегляд гуртків, які відвідують ваші діти, та статуси заявок на визнання"
      />
      ...
      {clubGroups.length === 0 && (
        <EmptyState
          ...
          description="Коли ви створите заявки на визнання для своїх дітей, пов'язані гуртки з'являться тут."
        />
      )}
