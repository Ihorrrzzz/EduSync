  ...
  return (
    <div className="space-y-6">
      <PageHeading
        ...
        description={
          isParent
            ? "Тут ви бачите статус кожного запиту, AI-підсумок, рішення школи та можете перейти до деталей."
            : "Тут ви додаєте підсумок доказів і стежите, де школа вже залишила своє рішення."
        }
        actions={
          isParent ? (
            <Link
      ...
      {records.length === 0 ? (
        <EmptyState
          ...
          description={
            isParent
              ? "Оберіть програму з каталогу, щоб створити ваш перший запит на врахування."
              : "Тут ви побачите запити, коли батьки оберуть одну з ваших програм."
          }
        />
      ) : (
