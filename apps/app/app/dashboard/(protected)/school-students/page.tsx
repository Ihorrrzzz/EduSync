    ...
    return (
      <div className="space-y-8">
        <PageHeading
          ...
          title="Учні"
          description="Тут ви бачите учнів, які подали запити на визнання результатів навчання у гуртках."
        />
        <SurfaceCard>
    ...
    <div className="space-y-8">
      ...
      {requests.length === 0 ? (
        <EmptyState
          ...
          description="Поки що запитів не надходило. Тут ви побачите учнів, коли батьки подадуть запити до вашої школи."
        />
      ) : (
        <>
          {/* Summary metrics */}
